...
class FooObjectBuilder extends fb.ObjectBuilder {
  final FooPropertiesObjectBuilder? myFoo;

  const FooObjectBuilder({
    this.myFoo,
  });
  ...
  int finish(fb.Builder fbBuilder) {
    fbBuilder.startTable(1);
    if (myFoo != null) {
      fbBuilder.addStruct(0, myFoo!.finish(fbBuilder));
    }
    return fbBuilder.endTable();
  }
...
class FooPropertiesObjectBuilder extends fb.ObjectBuilder {
  ...
  const FooPropertiesObjectBuilder({
    required this.a,
    required this.b,
  });
