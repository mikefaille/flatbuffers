...
class MonsterObjectBuilder extends fb.ObjectBuilder {
  ...
  }) : assert((test == null) == (testType == null || testType == AnyTypeId.NONE), 'Union test requires matching type and value'),
    assert((anyUnique == null) == (anyUniqueType == null || anyUniqueType == AnyUniqueAliasesTypeId.NONE), 'Union anyUnique requires matching type and value'),
    assert((anyAmbiguous == null) == (anyAmbiguousType == null || anyAmbiguousType == AnyAmbiguousAliasesTypeId.NONE), 'Union anyAmbiguous requires matching type and value');
